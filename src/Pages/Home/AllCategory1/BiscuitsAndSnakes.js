...
const BiscuitsAndSnakes = () => {

   



 const {data:biscuitsSnakes = [] } = useQuery({
    queryKey:['biscuitsSnakes'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Biscuits_Snakes')
        ...
        <div className='px-12'>
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* biscuitsSnakes all Products START______________________________________________________ */}


                    <div className=''>
                    {   
                biscuitsSnakes?.map(biscuitsSnake => {
                    return (
                        <div  key={biscuitsSnake._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={biscuitsSnake.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base  text-slate-700 font-serif">{biscuitsSnake.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{biscuitsSnake.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{biscuitsSnake.price}</button>
              ...
              {/* biscuitsSnake all Products END______________________________________________________ */}
...
export default BiscuitsAndSnakes;