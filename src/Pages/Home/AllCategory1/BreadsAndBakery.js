...
// export default BreadsAndBakery;
...
const BreadsAndBakery = () => {
 ...
 const {data:breadsbakery = [] } = useQuery({
    queryKey:['breadsbakery'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Breads_Bakery')
        ...
        <div className='px-12'>
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* breadsbakeryy all Products START______________________________________________________ */}


                    <div className=''>
                    {   
                breadsbakery?.map(breadsbakeryy => {
                    return (
                        <div  key={breadsbakeryy._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={breadsbakeryy.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base text-slate-700 font-serif">{breadsbakeryy.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{breadsbakeryy.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{breadsbakeryy.price}</button>
              ...
              {/* breadsbakeryy all Products END______________________________________________________ */}
