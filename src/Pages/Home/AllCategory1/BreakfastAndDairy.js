...
const BreakfastAndDairy = () => {
 ...
 const {data:breakfastdairy = [] } = useQuery({
    queryKey:['breakfastdairy'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Breakfast_Dairy')
        ...
        <div className='px-12'>
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* breakfastdairyy all Products START______________________________________________________ */}


                    <div className=''>
                    {   
                breakfastdairy?.map(breakfastdairyy => {
                    return (
                        <div  key={breakfastdairyy._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={breakfastdairyy.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base text-slate-700 font-serif">{breakfastdairyy.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{breakfastdairyy.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{breakfastdairyy.price}</button>
              ...
              {/* breakfastdairyy all Products END______________________________________________________ */}
