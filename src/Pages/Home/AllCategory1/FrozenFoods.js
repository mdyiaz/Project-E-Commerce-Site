...
const FrozenFoods = () => {
 ...
 const {data:foodsfrozen = [] } = useQuery({
    queryKey:['foodsfrozen'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Frozen_Foods')
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* breadsbakeryy all Products START______________________________________________________ */}
                    ...
                    <div className=''>
                    {   
                foodsfrozen?.map(foodsfrozenn => {
                    return (
                        <div  key={foodsfrozenn._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={foodsfrozenn.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base text-slate-700 font-serif">{foodsfrozenn.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{foodsfrozenn.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{foodsfrozenn.price}</button>
              ...
              {/* foodsfrozen all Products END______________________________________________________ */}
