...
// export default MeatsAndSeafoods;
...
const MeatsAndSeafoods = () => {
 ...
 const {data:meatsseafood = [] } = useQuery({
    queryKey:['meatsseafood'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Meets_Seafoods')
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* grocerystaple all Products START______________________________________________________ */}
                    ...
                    <div className=''>
                    {   
                meatsseafood?.map(meatsseafoodd => {
                    return (
                        <div  key={meatsseafoodd._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={meatsseafoodd.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base text-slate-700 font-serif">{meatsseafoodd.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{meatsseafoodd.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{meatsseafoodd.price}</button>
