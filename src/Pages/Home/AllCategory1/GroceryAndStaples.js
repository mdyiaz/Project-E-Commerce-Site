...
const GroceryAndStaples = () => {

   



 const {data:grocerystaples = [] } = useQuery({
    queryKey:['grocerystaples'],
    queryFn: async () => {
        const res = await fetch('https://e-commerce-server-site.vercel.app/allproducts/Grocery_Staples')
        ...
        <div className='px-12'>
            ...
            <div className='flex gap-16'>
                ...
                <div className='grow'>
                 ...
                 {/* grocerystaple all Products START______________________________________________________ */}


                    <div className=''>
                    {   
                grocerystaples?.map(grocerystaple => {
                    return (
                        <div  key={grocerystaple._id}>

                            <div className="card card-side bg-base-100 shadow-xl">
                                <figure><img src={grocerystaple.picture}alt="Movie" className='h-40'/></figure>
                                <div className="card-body">
                                    <h2 className="card-title text-base text-slate-700 font-serif">{grocerystaple.name}</h2>
                                    <p className='text-green-600 font-bold text-xs'>{grocerystaple.stock}</p>
                                    ...
                                    <div className="card-actions justify-between ">
                                        <button className="btn btn-success btn-sm text-white ">{grocerystaple.price}</button>
              ...
              {/* grocerystaple all Products END______________________________________________________ */}
...
export default GroceryAndStaples;